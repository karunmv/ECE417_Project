...
#define NODE_MAIN_LOGGER_NAME "aruco_tracker_autostart"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libaruco_opencv.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<aruco_opencv::ArucoTrackerAutostart>";
